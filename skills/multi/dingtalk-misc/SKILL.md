...
| DEAP 数字员工 / 数字员工 / 人设 / 群感知 / 临时 DWS token / 执行状态 / 执行 trace / 响应模式 | DEAP 数字员工管理态（创建/草稿/发布/删除/详情/列表/临时 DWS token）与观测态（执行状态/trace） | `dws deap` | [deap/deap-index.md](references/deap/deap-index.md) |
